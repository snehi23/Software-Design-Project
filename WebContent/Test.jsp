...
<script>
	...
	$(document).ready(function () {
		...
		//highlight selected image by creating a shadow
		...
		//change the values as per the change in unit of measurement by user on result page
		...
		//User wants to change dimension. show input forms with option to selected shape to build
		...
		//Ajax to server, get the result object
		//create the output div with all images and voulme length, breadth height values.
		$('#submitIt').click(function(event) {
			...
			if (validateInput() == true) {
				...
				$.post('VolCalController',{"length":length,"breadth":breadth,"height":height,"unit":selunit,"shape":selShape},function(data){		
							...
							//show shape related options
							showOption();
							
							// get the object as per unit of measurement provided by user
							if( selunit == "meters"){
							...
							//populate all values associated with the case and the unit of measurement
